...
import org.app.saveourpets.datos.Raza
import org.app.saveourpets.datos.RazaAdapter
...
class RazasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_razas, container, false)

        recyclerView = view.findViewById(R.id.list_Razas)
